...
namespace UnityStandardAssets.CrossPlatformInput
{
	public class JoystickWalk : MonoBehaviour, IPointerDownHandler, IPointerUpHandler, IDragHandler
	{
		...
		public string horizontalAxisName = "Hori"; // The name given to the horizontal axis for the cross platform input
		public string verticalAxisName = "Vert"; // The name given to the vertical axis for the cross platform input
