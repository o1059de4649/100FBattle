...
namespace UnityStandardAssets.CrossPlatformInput
{
    ...
    public class MiddleBullet : Photon.MonoBehaviour
    {
        ...
        void OnCollisionStay(Collision col)
        {
            if (col.gameObject == p_player)
            {
                ...
                p_player.GetComponent<UnityChanControlScriptWithRgidBody>().u_photonView.RPC("MiddleBulletGet", PhotonTargets.All);
