...
namespace UnityStandardAssets.CrossPlatformInput
{
    ...
    public class PhotonUnitychanControl : Photon.MonoBehaviour
    {
...
*/
        ...
        public void PhotonAttackAudio()
        {

            audioSource.PlayOneShot(audio_clip[0]);
        }

        public void PhotonGetEssence()
        {
            audioSource.PlayOneShot(audio_clip[1]);
        }

        public void PhotonWalkingAudio()
        {
            int i = Random.Range(3, 6);
            audioSource.PlayOneShot(audio_clip[i]);
        }

        public void PhotonRunningAudio()
        {
            int i = Random.Range(3, 6);
            audioSource.PlayOneShot(audio_clip[i]);
        }

        public void PhotonAudioOff()
        {
            audioSource.Stop();
        }


        public void PhotonAttackSwordOn()
        {
        ...
        public void PhotonAttackSwordOff()
        {
