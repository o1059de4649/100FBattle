...
namespace UnityStandardAssets.CrossPlatformInput
{
    public class BoneMagic : MonoBehaviour
    {
        ...
        private void OnParticleCollision(GameObject enemyObj)
        {
            ...
            {
                if( enemyObj.name == "icedemon(Clone)" ||enemyObj.name == "Skeleton(Clone)" || enemyObj.name == "SkeletonWeak1(Clone)" || enemyObj.name == "SkeletonWeak2(Clone)" || enemyObj.name == "SkeletonMedium1(Clone)" || enemyObj.name == "SkeletonMedium2(Clone)" || enemyObj.name == "demon(Clone)" || enemyObj.name == "SkeletonStrong(Clone)" || enemyObj.name == "demonBoss(Clone)"){
